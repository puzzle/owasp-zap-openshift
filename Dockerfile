...
RUN set -o pipefail && wget -q --content-disposition -i https://github.com/zaproxy/zaproxy/releases/download/v${ZAP_VER}/ZAP_${ZAP_VER}_Linux.tar.gz -O - | tar zx --strip-components=1 && \
    curl -s -L https://bitbucket.org/meszarv/webswing/downloads/webswing-2.7.5.zip | jar -x && \
    touch AcceptedLicense
ADD webswing.config /zap/webswing-2.7.5/webswing.config
